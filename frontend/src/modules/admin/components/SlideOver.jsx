      ...
      <div className="pointer-events-none fixed inset-y-0 right-0 flex max-w-full sm:pl-10">
        <div className={`pointer-events-auto w-screen ${widthClass} transform transition-transform duration-300 ease-in-out`}>
          <div className="flex h-full flex-col bg-background shadow-2xl">
            {/* Header */}
            <div className="px-6 py-4 bg-background border-b border-gray-100 flex items-center justify-between relative overflow-hidden">
            ...
            {/* Content Body */}
            <div className="relative flex-1 px-4 sm:px-6 py-6 overflow-y-auto no-scrollbar bg-background">
              {children}
            </div>

        ...
        <div className="w-full max-w-lg space-y-6">
          ...
          <div className="flex items-center justify-between px-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-900 font-black text-sm tracking-tighter">Offerly</span>
            </div>
          </div>
            ...
            <div className="relative z-10 space-y-6">
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="mt-4 text-center">
                  <h2 className="text-gray-900 font-black text-xl tracking-tight">Create Identity</h2>
              ...
              <form onSubmit={handleSignup} className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <input name="name" value={formData.name} onChange={handleChange} placeholder="Full Name" className="w-full h-12 pl-11 pr-4 bg-[#F8F5FF] rounded-2xl border border-gray-50 text-sm font-bold outline-none focus:bg-white focus:border-[#3D7A4F]/30 transition-all" />
                    </div>
                  </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <input type="email" name="email" value={formData.email} onChange={handleChange} placeholder="Email" className="w-full h-12 pl-11 pr-4 bg-[#F8F5FF] rounded-2xl border border-gray-50 text-sm font-bold outline-none focus:bg-white focus:border-[#3D7A4F]/30 transition-all" />
                    </div>
                  </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <input type="tel" name="phone" value={formData.phone} onChange={handlePhoneChange} placeholder="Phone" className="w-full h-12 pl-11 pr-4 bg-[#F8F5FF] rounded-2xl border border-gray-50 text-sm font-bold outline-none focus:bg-white focus:border-[#3D7A4F]/30 transition-all" />
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="space-y-1.5">
                      ...
                      <input type="number" name="age" value={formData.age} onChange={handleChange} placeholder="Age" className="w-full h-12 px-4 bg-[#F8F5FF] rounded-2xl border border-gray-50 text-sm font-bold outline-none focus:bg-white focus:border-[#3D7A4F]/30 transition-all" />
                    </div>
                    <div className="space-y-1.5">
                      <label className="text-[10px] font-bold text-gray-400 px-1">Gender</label>
                      <select name="gender" value={formData.gender} onChange={handleChange} className="w-full h-12 px-3 bg-[#F8F5FF] rounded-2xl border border-gray-50 text-xs font-bold outline-none focus:bg-white focus:border-[#3D7A4F]/30 transition-all">
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea name="address" value={formData.address} onChange={handleChange} rows="2" placeholder="Full Address" className="w-full p-4 bg-[#F8F5FF] rounded-2xl border border-gray-50 text-sm font-bold outline-none focus:bg-white focus:border-[#3D7A4F]/30 transition-all resize-none" />
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input name="referralCode" value={formData.referralCode} onChange={handleChange} placeholder="Enter code" className="w-full h-12 pl-11 pr-4 bg-[#F8F5FF] rounded-2xl border border-gray-50 text-sm font-bold outline-none focus:bg-white focus:border-[#3D7A4F]/30 transition-all uppercase" />
                  </div>
                </div>

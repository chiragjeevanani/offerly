    ...
    <PageTransition>
      <div className="min-h-screen bg-background pb-24">
        ...
        <div className="px-5 pt-8 pb-12 relative overflow-hidden bg-white rounded-b-[3rem] shadow-[0_4px_24px_rgba(0,0,0,0.03)] border-b border-gray-100">
           {/* Abstract Decoration */}
           <div className="absolute top-0 right-0 w-32 h-32 bg-[#5EB929]/5 rounded-full -mr-16 -mt-16 blur-3xl" />
           
           <div className="flex items-center gap-5 relative z-10">
              <div className="w-20 h-20 bg-[#5EB929]/5 rounded-3xl flex items-center justify-center border-2 border-[#5EB929]/10 shadow-sm">
                <span className="text-[#5EB929] text-4xl font-bold uppercase">
              ...
              <div className="flex-1">
                ...
                <div className="flex flex-col gap-1.5 mt-2">
                  <div className="flex items-center gap-1.5 bg-background w-fit px-2.5 py-1 rounded-lg border border-gray-100">
                    <LocationOnRoundedIcon sx={{ fontSize: 12 }} className="text-[#5EB929]" />
                    <span className="text-gray-600 text-[10px] font-bold uppercase tracking-tight">{user?.city || 'Not Set'}</span>
                  </div>
                  {user?.address && (
        ...
        <div className="px-5 -mt-6 relative z-20 space-y-4">
          ...
          {user?.referralCode && (
            <div className="bg-[#5EB929] rounded-[2rem] p-5 flex items-center justify-between shadow-lg shadow-[#5EB929]/20 relative overflow-hidden">
               ...
               >
                 <ContentCopyRoundedIcon sx={{ fontSize: 16 }} className="text-[#5EB929]" />
               </motion.button>
            </div>
          )}
            ...
            <div key={section.title} className="pt-2">
              ...
              <div className="space-y-2">
                {section.items.map((item) => (
                  ...
                  >
                    <div className="w-9 h-9 bg-background rounded-xl flex items-center justify-center flex-shrink-0">
                      <item.icon sx={{ fontSize: 18 }} className="text-gray-400" />
                    </div>
                    <span className="flex-1 text-[11px] font-bold text-gray-800 uppercase tracking-tight text-left">
                      {item.label}
                    </span>
      ...
      >
        <div className="p-5 space-y-4 pb-8">
          ...
          <div>
            <div className="flex items-center justify-between mb-2 px-1">
              ...
              <button 
                ...
                disabled={detecting}
                className="flex items-center gap-1 text-[9px] font-bold text-[#5EB929] uppercase tracking-tight bg-[#5EB929]/5 px-2 py-1 rounded-lg border border-[#5EB929]/10 active:scale-95 transition-all"
              >
                {detecting ? (
                  <div className="w-2.5 h-2.5 border border-[#5EB929]/30 border-t-[#5EB929] rounded-full animate-spin" />
                ) : (
            ...
            <textarea
              ...
              rows="3"
              className="w-full px-4 py-3.5 rounded-xl border border-gray-100 bg-background/50 focus:bg-white focus:border-[#5EB929] outline-none transition-all text-sm font-bold resize-none"
            />
          </div>
          ...
          <div>
            ...
            />
            <p className="text-[8px] font-bold text-gray-300 uppercase tracking-widest mt-2 px-1">Primary identifier cannot be modified</p>
          </div>
          ...
          <motion.button
            ...
            disabled={saving}
            className="w-full bg-[#5EB929] text-white font-bold text-[11px] uppercase tracking-[0.2em] py-4 rounded-2xl shadow-lg shadow-[#5EB929]/20 active:scale-95 transition-all flex items-center justify-center gap-2 disabled:opacity-50"
          >
            {saving ? (

    ...
    <PageTransition>
      <div className="min-h-screen bg-background px-4 py-4 pb-24 space-y-8">
        ...
        <div className="bg-[#5EB929] rounded-[2.5rem] p-8 text-center relative overflow-hidden shadow-lg shadow-[#5EB929]/20">
           ...
           <h1 className="text-white font-bold text-2xl uppercase tracking-tight">Contact Support</h1>
          ...
          <div className="space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              <div className="bg-white rounded-2xl p-4 border border-gray-50 shadow-sm space-y-4">
                 ...
                 <div>
                   ...
                   <select
                     ...
                     onChange={handleChange}
                     className="w-full px-4 py-3.5 rounded-xl border border-gray-100 bg-background/50 focus:bg-white focus:border-[#5EB929] outline-none transition-all text-sm font-bold uppercase tracking-tight"
                     required
                   >
              ...
              <button
                ...
                className="w-full bg-[#5EB929] text-white font-bold text-[11px] uppercase tracking-[0.2em] py-4 rounded-2xl shadow-lg shadow-[#5EB929]/20 active:scale-95 transition-all flex items-center justify-center gap-2"
              >
                {isSubmitting ? (

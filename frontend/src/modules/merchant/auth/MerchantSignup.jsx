        ...
        <div className="w-full max-w-lg space-y-6 py-10">
          ...
          <div className="flex items-center justify-between px-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-900 font-bold text-sm tracking-tight uppercase">Offerly<span className="text-[#5EB929] italic">Biz</span></span>
            </div>
          </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <input name="name" required value={formData.name} onChange={handleChange} placeholder="Full Name" className="w-full h-12 pl-11 pr-4 bg-background rounded-2xl border border-gray-50 text-sm font-bold outline-none focus:bg-white focus:border-[#5EB929]/30 transition-all" />
                    </div>
                  </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <input type="email" name="email" required value={formData.email} onChange={handleChange} placeholder="Email" className="w-full h-12 pl-11 pr-4 bg-background rounded-2xl border border-gray-50 text-sm font-bold outline-none focus:bg-white focus:border-[#5EB929]/30 transition-all" />
                    </div>
                  </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <select name="businessType" required value={formData.businessType} onChange={handleChange} className="w-full h-12 pl-11 pr-4 bg-background rounded-2xl border border-gray-50 text-xs font-bold outline-none focus:bg-white focus:border-[#5EB929]/30 appearance-none transition-all">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <input type="tel" name="phone" required value={formData.phone} onChange={handlePhoneChange} placeholder="Phone" className="w-full h-12 pl-11 pr-4 bg-background rounded-2xl border border-gray-50 text-sm font-bold outline-none focus:bg-white focus:border-[#5EB929]/30 transition-all" />
                    </div>
                  </div>
                </div>

...
const RegistrationSuccess = ({ merchant }) => {
  ...
  return (
    <div className="max-w-md mx-auto py-6 px-4">
      ...
      >
        {/* Background Sparkle */}
        <div className="absolute top-0 right-0 w-24 h-24 bg-[#3D7A4F]/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2" />
        ...
        <div className="relative z-10 space-y-6">
          <motion.div
            ...
            className="w-16 h-16 bg-[#3D7A4F]/10 rounded-[1.5rem] flex items-center justify-center mx-auto shadow-lg shadow-[#3D7A4F]/5"
          >
            <CheckCircleRoundedIcon sx={{ fontSize: 32 }} className="text-[#3D7A4F]" />
          </motion.div>

          <div className="space-y-1.5">
            <h1 className="text-gray-900 font-black text-xl tracking-tighter uppercase leading-tight">
          ...
          <div className="bg-[#F8F5FF] rounded-[2rem] p-5 md:p-6 space-y-5 text-left border border-gray-50">
             <div className="flex items-center gap-2 mb-1">
                <div className="w-1 h-1 bg-[#3D7A4F] rounded-full" />
                <h3 className="text-[9px] font-black text-gray-400 uppercase tracking-widest">Protocol timeline</h3>
             </div>
                ...
                {[
                  ...
                  <div key={idx} className="flex gap-3.5 relative">
                    ...
                    <div className="w-9 h-9 bg-white rounded-xl border border-gray-100 flex items-center justify-center flex-shrink-0 shadow-sm relative z-10">
                      <step.icon sx={{ fontSize: 16 }} className="text-[#3D7A4F]" />
                    </div>
                    <div className="space-y-0">
                      <p className="text-[11px] font-black text-gray-900 tracking-tight">{step.title}</p>
          ...
          <div className="bg-[#3D7A4F]/5 rounded-xl p-3 flex items-center justify-between">
             <div className="flex flex-col items-start">
                <span className="text-[8px] font-black text-[#3D7A4F] uppercase tracking-widest">Est. verification</span>
          ...
          <motion.button
            ...
            className="w-full h-12 bg-[#3D7A4F] text-white rounded-2xl font-black text-[11px] shadow-lg shadow-[#3D7A4F]/20 flex items-center justify-center gap-2 active:scale-95 transition-all"
          >

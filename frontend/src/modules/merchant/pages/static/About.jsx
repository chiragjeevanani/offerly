...
const FeatureStrip = ({ icon: Icon, title, description, idx }) => (
  <motion.div
    ...
    className="bg-white rounded-2xl p-5 border border-gray-50 shadow-sm flex items-start gap-4 hover:border-[#5EB929]/20 transition-all"
  >
    <div className="w-10 h-10 rounded-xl bg-background text-[#5EB929] flex items-center justify-center flex-shrink-0">
      <Icon sx={{ fontSize: 20 }} />
    </div>
    <div className="min-w-0">
      <h3 className="text-[14px] font-bold text-gray-900 leading-tight mb-1">{title}</h3>
  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="sticky top-0 z-50 bg-white/80 backdrop-blur-xl border-b border-gray-100 px-4 py-3 flex items-center gap-3">
        ...
        <h1 className="text-[15px] font-bold text-gray-900 uppercase tracking-widest">About Enterprise</h1>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8 space-y-10">
        ...
        <div className="bg-gray-900 rounded-[2.5rem] p-6 sm:p-8 lg:p-10 relative overflow-hidden shadow-2xl">
           ...
           <div className="relative z-10 flex flex-col sm:flex-row items-center gap-6 lg:gap-10">
              <motion.div initial={{ scale: 0.9, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="w-12 h-12 lg:w-16 lg:h-16 bg-white/5 border border-white/10 rounded-2xl flex items-center justify-center flex-shrink-0">
                 <StorefrontRoundedIcon sx={{ fontSize: { xs: 24, lg: 32 } }} className="text-[#5EB929]" />
              </motion.div>
        ...
        <div className="space-y-6">
           <div className="flex items-center gap-3 px-1">
              ...
              <h3 className="text-[11px] font-bold text-gray-900 uppercase tracking-widest">Platform DNA</h3>
           </div>
        ...
        <div className="bg-[#5EB929]/5 rounded-3xl p-8 border border-[#5EB929]/10">
           ...
           <div className="grid grid-cols-1 sm:grid-cols-4 gap-8">
              {[
                 ...
                 >
                    <div className="w-10 h-10 rounded-full bg-[#5EB929] text-white flex items-center justify-center font-bold text-sm mx-auto mb-3 shadow-lg shadow-[#5EB929]/20">{i+1}</div>
                    <h4 className="text-[13px] font-bold text-gray-900 mb-1">{step.t}</h4>
        ...
        {/* Final CTA Strip */}
        <div className="bg-[#5EB929] rounded-[2rem] p-10 text-center space-y-6 relative overflow-hidden shadow-2xl shadow-[#5EB929]/20">
        ...
        <div className="text-center py-6">
           <p className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.4em]">Offerly Enterprise v1.0.4</p>
        </div>
      </div>
    </div>
  );

...
const ContactStrip = ({ icon: Icon, title, value, action, color, idx }) => (
  <motion.div
    ...
    onClick={action}
    className="bg-white p-4 rounded-2xl border border-gray-50 shadow-sm flex items-center gap-4 hover:border-[#5EB929]/20 hover:shadow-md transition-all cursor-pointer group"
  >
    <div className={`w-10 h-10 rounded-xl bg-background ${color} flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform`}>
      <Icon sx={{ fontSize: 20 }} />
    </div>
  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      ...
      <div className="max-w-4xl mx-auto px-4 py-8 space-y-10">
        ...
        <div className="space-y-6">
           ...
           >
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                 ...
                 <div className="space-y-2">
                    <label className="text-[10px] font-bold text-gray-400 uppercase tracking-widest px-1">Communication Email</label>
                    <input required type="email" placeholder="email@address.com" className="w-full bg-background border border-transparent focus:border-[#5EB929]/20 rounded-xl px-4 py-3 text-[13px] font-bold outline-none transition-all" />
                 </div>
              </div>
              <div className="space-y-2">
        ...
        {/* Operational Hours */}
        <div className="bg-[#5EB929]/5 rounded-3xl p-8 border border-[#5EB929]/10">
           <div className="flex items-center gap-4 mb-6">
              <div className="w-10 h-10 rounded-xl bg-white text-[#5EB929] flex items-center justify-center shadow-sm"><AccessTimeRoundedIcon sx={{ fontSize: 20 }} /></div>
              <h3 className="text-[14px] font-bold text-gray-900 uppercase tracking-widest">Support Uptime</h3>
           </div>
           <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 text-[12px] font-bold">
              <div className="flex justify-between items-center border-b border-[#5EB929]/10 pb-4">
              ...
              <div className="flex justify-between items-center col-span-full">
                 <span className="text-[10px] font-bold text-[#5EB929] uppercase tracking-widest">* Emergency Call Desk Active 24/7</span>
              </div>
           </div>
        </div>

        <div className="text-center py-6">
           <p className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.4em]">Offerly Enterprise Contact Hub</p>
        </div>
      </div>
    </div>
  );
